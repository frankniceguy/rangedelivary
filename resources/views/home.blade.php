...
<body>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <di class="container text-center py-5">
            <h1 class="text-primary mb-4">Safe & Faster</h1>
            <h1 class="text-white display-3 mb-5">Logistics Services</h1>
            <form action="/tracking" method="POST" class="mx-auto" style="width: 100%; max-width: 600px;">
                @csrf
                <div class="input-group">
                    <input type="text" name="id" class="form-control border-light" style="padding: 30px;"
