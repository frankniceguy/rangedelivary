        ...
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row"
              ...
              <div
              class="bg-primary"
                style="border-collapse: collapse;display: table;width: 100%;height: 100%;">
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #4d148c;"><![endif]-->
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    <a href="https://fdxcompany.com" target="_blank">
                                      <img align="center" border="0"
                                        src="{{ asset('/assets/images/'.config('site.dark')) }}" alt="Logo" title="Logo"
                                        style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 20%;max-width: 226.2px;"
                                        width="226.2" class="v-src-width v-src-max-width" />
                                    </a>
                                  </td>
                                </tr>
                              </table>
                ...
                <div class="u-col u-col-100"
                  ...
                  <div
                    ...
                    <div
                      ...
                      <table id="u_content_heading_3" style="font-family:'Montserrat',sans-serif;padding-top: 37px;"
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <h1 class="v-font-size"
                                ...
                                <span><strong>{{ $subject }}</strong></span></h1>
                            ...
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-font-size"
                                ...
                                <p style="font-size: 14px; line-height: 170%;"><span
                                    style="font-size: 16px; line-height: 27.2px;">{!! $content !!}</span></p>
                              </div>
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <h1 class="v-font-size"
                                ...
                                <strong>Need anything else?</strong></h1>
                              <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div align="center">
                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://fdxcompany.com/contact" style="height:47px; v-text-anchor:middle; width:172px;" arcsize="8.5%"  stroke="f" fillcolor="#ab9900"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
                                <a href="https://fdxcompany.com/contact" target="_blank" class="v-button v-font-size bg-secondary"
                            ...
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-font-size"
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-size: 18px; line-height: 25.2px;"><strong>{{ config('site.name') }}
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-font-size"
                                style="font-size: 14px; color: #b0b1b4; line-height: 180%; text-align: center; word-wrap: break-word;">
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://facebook.com/" title="Facebook" target="_blank">
                                            <img src="{{ asset('/assets/images/email/image-4.png') }}" alt="Facebook"
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://twitter.com/" title="Twitter" target="_blank">
                                            <img src="{{ asset('/assets/images/email/image-2.png') }}" alt="Twitter"
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://instagram.com/" title="Instagram" target="_blank">
                                            <img src="{{ asset('/assets/images/email/image-1.png') }}" alt="Instagram"
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://linkedin.com/" title="LinkedIn" target="_blank">
                                            <img src="{{ asset('/assets/images/email/image-3.png') }}" alt="LinkedIn"
